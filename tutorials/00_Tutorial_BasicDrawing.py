...
# Note that this will first copy, then translate, then scale, setting the layer and
# finally adding to re0. It is very common to copy and then translate or change layer.
# The following allows it to do this explicitly.
