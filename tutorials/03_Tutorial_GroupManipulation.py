...
# The following bloats the polygons in layer 1 by 2 um in all directions, note that
# elements will merge.
# Use negative values to shrink
res1.poly_resize(2.0, 1)
res1.translate(20, 0)

g += res1  # adding the result to the main Geometry

# OUTLINING:
# You can make the outline of a shape:
out1 = base.copy()
out1.set_layer(1)
# Create an outline of the shape with width of 0.3 um:
