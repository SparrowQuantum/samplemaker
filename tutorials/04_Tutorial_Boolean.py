...
# Boolean operations alter the original element so we need to make a copy first:
bdiff = box0.copy()
bdiff.boolean_difference(text0, 1, 1)
# The first integer is the layer from which you should subtract and the second is the
# subtracted layer.
